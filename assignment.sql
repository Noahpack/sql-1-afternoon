...
( person_id SERIAL PRIMARY KEY, name VARCHAR(200), age INTEGER, height INTEGER, city VARCHAR(200), favorite_color VARCHAR(200) );     
 ...
 VALUES ( 'Noah Pack', 18, 178, 'Orem', 'Blue'),
        ( 'Logan Christansen', 18, 185, 'Orem', 'Red'),
       ( 'Hugh Jackman', 52, 190, 'X Mansion', 'Yellow'),
       ( 'Luke Skywalker', 19, 185, 'Tatooine', 'blue'),
       ('Harry Potter', 12, 167, 'Hogwarts', 'Red'),;
...
VALUES 
(1, 'CheeseBurger', 4.25, 2 ),
(2, 'Fries', 2.25, 4),
(3, 'Shake', 3.50, 3),
(4, 'Drink', 1.90, 2),
(5, 'Chicky Tenders', 4.00, 1);
SELECT * FROM orders;
SELECT SUM(12) FROM orders;
